...
Details of data sources used for the current ADRs dataset (cyp_substrates_adrs.csv) will be documented in the ADRs data note (**1_ADR_data.qmd -> to add updated html version**). 

<br>

###### **Data curation**

Before immersing in the process of curating ADRs data, I've made a visit to PubMed briefly to search for papers regarding ADRs, trying to find out which drugs or therapeutic areas are commonly involved in ADRs in real-life. I've found 3 papers that have investigated within critical care settings within hospitals, primary care settings in the communities and worldwide drug withdrawals regarding ADRs. The key problematic therapeutic areas involved in ADRs are: 

* antimicrobials (for critical medical setting)
* cardiovascular system/anticoagulants (for critical & primary settings)
* analgesics & sedatives (for critical surgical setting)
