...
**Update on 15th Feb 25**: adding ADRs of strong and moderate CYP2D6 substrates slowly from February 2025. Also, a small discovery re. CYP data used in many ADMET prediction apps - they all seem to be using *in vitro*-based data (although I haven't checked what PubChem uses as a few cites using CYP data from it), so I think if the Flockhart table can be utilised at the same time (*in-vivo* use in humans), this may make research in ADMET more well-covered and may improve data quality even more.
