...
* 2nd-line as separate data checks: 
  ...
  - [electronic medicines compendium (emc)](https://www.medicines.org.uk/emc) - UK-based drug reference; equivalents of UK/Europe-based pharmaceutical manufacturers' medicines data sheets
...
- all ADRs of flatulence (and abdominal discomforts if there are already abdominal pains present) are removed as the current focus will be more on ADRs that'll affect qualities of lives and also the more debilitating types that may lead to life-threatening scenarios
