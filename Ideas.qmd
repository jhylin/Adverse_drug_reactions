...
* Drug molecular representations for drug structures e.g. SMILES, SMARTS etc. from other sources e.g. PubChem or ChEMBL or others
...
*Mermaid chart to show flow of ideas (work-in-progress)*
...
flowchart TB
  ...
  E(postmarketing surveillance) --> C(ADRs)
  F(target) --> B(activities)
  A <--> F(target)
  F --> C(ADRs)
  G(CYP3A4/5 substrates) --> C(ADRs)
  A <--> G(CYP3A4/5 substrates)
```
